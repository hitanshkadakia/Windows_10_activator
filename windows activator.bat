...
cscript //nologo slmgr.vbs /ato | find /i "successfully" && (echo.&echo ============================================================================&echo.&echo #How it works: bit.ly/kms-server&echo.&echo #Please feel free to contact me at hitanshchiragkadakia@gmail.com if you have any questions or concerns.&echo.============================================================================&choice /n /c YN /m "Would you like to visit my website [Y,N]?" & if errorlevel 2 exit) || (echo The connection to my KMS server failed! Trying to connect to another one... & echo Please wait... & echo. & echo. & set /a i+=1 & goto server)
explorer "https://linktr.ee/happy_coding01"&goto halt
:notsupported
